...
/** Devuelve métricas del panel: pedidos, ventas, proveedores, insumos y productos en paralelo */
exports.getDashboard = asyncHandler(async (req, res) => {
    const [
        ...
        pool.query("SELECT COALESCE(SUM(totalventa), 0) AS total FROM ventas WHERE DATE(fechaventa) = CURRENT_DATE"),
