...
exports.getProveedores = asyncHandler(async (req, res) => {
    const result = await pool.query('SELECT * FROM proveedores ORDER BY idproveedor ASC')
...
exports.updateProveedor = asyncHandler(async (req, res) => {
    const { id } = req.params
    const { nombreProveedor, contactoProveedor, telefonoProveedor, correoProveedor } = req.body
...
exports.updateEstado = asyncHandler(async (req, res) => {
    ...
    res.json({ success: true, message: 'Estado del proveedor actualizado exitosamente' })
})
